public class Main {
    public static void main(String[] args) {
        ...
        headquarters[0] = new Soldier("Soldier 1");
        headquarters[1] = new Soldier("Soldier 2");
        headquarters[2] = new Soldier("Soldier 3");
        headquarters[3] = new Soldier("Soldier 4");
        headquarters[4] = new Soldier("Soldier 5");
        headquarters[5] = new Soldier("Soldier 6");
